    ...
    switch($_GET["op"]){
        case 'guardaryeditar':
            if(empty($idpersona)){
                ...
                echo $rspta?"Persona registrada":"Persona no se registro";
            }else{
                $rspta=$persona->editar($idpersona, $tipo_persona, $nombre, $tipo_documento, $num_documento, $direccion, $telefono, $email);
                echo $rspta?"Persona actualizada":"Persona no se actualizo";
            }
        ...
        case 'eliminar':
            ...
            echo $rspta?"Persona desactivada":"Persona no se desactivo";
        break;
